...
#   $2 - optional comma-separated table list (default: cpu,ram,swap,kernel,net,netflow,disk,fs,process,magent_internal)
# Return:
#   0 on success; non-zero on client/query failure.

DB_NAME="${1:-metrics}"
TABLE_LIST_RAW="${2:-cpu,ram,swap,kernel,net,netflow,disk,fs,process,magent_internal}"
